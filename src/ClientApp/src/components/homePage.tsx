        ...
        <>
            <div className="bg-gray-200 dark:bg-gray-900">
                <div className="w-full bg-primary">
                    <div className="container dark:text-white text-gray-800 pb-2 mx-auto center-text">
            ...
            <div className="w-full pt-4">
                <div className="container text-base dark:text-gray-300 text-gray-800 pb-2 mx-auto max-w-7xl text-center">
                    <h1>Coming Soon</h1>
