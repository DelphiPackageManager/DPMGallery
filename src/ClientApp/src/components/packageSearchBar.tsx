        ...
        <div className="flex justify-center items-center py-2 w-full max-w-sm md:max-w-xl">
            <div className="w-full flex flex-col">
                <div className="relative flex justify-around items-center ">
                    ...
                    <input autoFocus type="text" name="q" id="search" className="w-full focus:outline-none focus:shadow-none  py-1 text-base text-gray-900  rounded-full pl-12 border-none placeholder:text-gray-100"
