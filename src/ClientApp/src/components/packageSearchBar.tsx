      ...
      <div className="w-full flex flex-col">
        <div className="relative flex justify-around items-center ">
          ...
          <input
            ...
            name="q"
            id="search"
            className="w-full focus:outline-none focus:shadow-none  py-1 text-base text-gray-900  rounded-full pl-12 border-none placeholder:text-gray-300 dark:placeholder:text-gray-600 dark:bg-gray-700 dark:text-white"
