import ReportPackagePage from "@/pages/packagePages/reportPackage";
...
import PackagesPage from "../pages/packagePages/packagesPage";
...
import APIKeysPage from "./account/apiKeys/apiKeysPage";
		...
		createRoutesFromElements(
			<Route path="/" element={<Layout />} errorElement={<ErrorPage />}>
				...
				<Route element={<RequireAuthRoute allowedRoles={["RegisteredUser", "Administrator"]} />}>
					<Route path="/packages/:packageId/:packageVersion/report" element={<ReportPackagePage />} />
				</Route>
