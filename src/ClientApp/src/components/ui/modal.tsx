...
function ModalContent({ title, children }: { title: string; children: ReactNode }) {
  return (
    <Dialog.Portal className="fixed top-0 left-0 z-50 w-full h-full overflow-x-hidden">
      ...
      <Dialog.Content className="fixed flex left-1/2 top-1/2 min-w-[35%] min-h-lg -translate-x-1/2 -translate-y-1/2 rounded-md bg-white  text-gray-900 shadow data-[state=closed]:animate-[dialog-content-hide_200ms] data-[state=open]:animate-[dialog-content-show_200ms]">
