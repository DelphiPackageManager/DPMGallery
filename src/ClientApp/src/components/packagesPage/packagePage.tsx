...
import { ArrowDownTrayIcon, AtSymbolIcon, ClockIcon, InformationCircleIcon, TagIcon } from "@heroicons/react/24/outline";
  ...
  return (
    <PageContainer>
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between w-full text-gray-600 dark:text-gray-300">
        ...
        <div className="grow">
          <div className="flex flex-row items-center mt-4 text-gray-700 dark:text-gray-100">
    ...
    */}
          ...
          <div
            className="flex items-center bg-primary-500/20 dark:bg-primary-500/50 text-gray-500 dark:text-gray-100 text-sm px-4 py-2 rounded-md "
            role="alert">
          ...
          <div className="my-2">
            <Tabs defaultValue="description" className="">
              <TabsList className="w-full border-b border-primary  text-base bg-white dark:bg-gray-800 items-start">
                ...
                <TabsTrigger value="compilers">Compilers/Platforms</TabsTrigger>
                <TabsTrigger value="versions">Versions</TabsTrigger>
              </TabsList>
              <TabsContent value="description">{reactContent}</TabsContent>
              <TabsContent value="compilers">
                <p>compilers</p>
              </TabsContent>
              <TabsContent value="versions">{reactContent}</TabsContent>
            </Tabs>
          </div>
        </div>
      </div>
