...
namespace DPMGallery.PackageExtraction
{
    ...
    {
        private static readonly int _unixPermissions = Convert.ToInt32("766", 8);
        private static readonly Lazy<Func<string, FileStream>> _createFileMethod = new Lazy<Func<string, FileStream>>(CreateFileMethodSelector);
