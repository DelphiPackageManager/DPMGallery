...
namespace DPMGallery.Extensions.Mapping
{
    public static class ApiKeyMappings
    {
        ...
        {
            var model = new ApiKeyModel(entity.Id, entity.Name, entity.Key, entity.UserId, entity.ExpiresUTC, entity.GlobPattern, entity.Packages, entity.PackageOwner, (int)entity.Scopes, entity.Revoked);
            return model;
        }
